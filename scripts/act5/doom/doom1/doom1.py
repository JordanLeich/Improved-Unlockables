...
if doom1 == 0
     ...
     cap = isActorOnTeam("CaptainAmerica" )
     iron = isActorOnTeam("IronMan" )
     panther = isActorOnTeam("BlackPanther" )
     ...
     if doc == 1
          ...
          if cap == 1
               if iron == 1
                    ...
                    createPopupDialogXml("dialogs/special/civil_achievement" )
                    waittimed ( 0.100 )
                    startCharConversation("act5/doom/doom1/5_doom1_010", "CaptainAmerica", "act5/doom/doom1/5_doom1_010" )
               else
                    if panther == 1
