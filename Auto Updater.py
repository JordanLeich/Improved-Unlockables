...
REPO_URL = "https://api.github.com/repos/JordanLeich/Improved-Unlockables/releases/latest"
# URL to download the source code zip for the latest release
ZIP_URL = "https://github.com/JordanLeich/Improved-Unlockables/archive/refs/tags/{tag_name}.zip"
